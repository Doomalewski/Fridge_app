...
namespace Fridge_app.Migrations
{
    ...
    [Migration("20260114222439_AddWeeklyMealsPlan")]
    partial class AddWeeklyMealsPlan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fridge_app.Models.ShoppingList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fridge_app.Models.ShoppingListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("IsAddedToFridge")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Fridge_app.Models.WeeklyMealPlanDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fridge_app.Models.ShoppingListItem", b =>
                {
                    b.HasOne("Fridge_app.Models.ShoppingList", "ShoppingList")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Fridge_app.Models.WeeklyMealPlanDay", b =>
                {
                    b.HasOne("Fridge_app.Models.Meal", "BreakfastMeal")
                        .WithMany()
                        .HasForeignKey("BreakfastMealId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Fridge_app.Models.Meal", "DinnerMeal")
                        .WithMany()
                        .HasForeignKey("DinnerMealId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Fridge_app.Models.Meal", "LunchMeal")
                        .WithMany()
                        .HasForeignKey("LunchMealId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Fridge_app.Models.Meal", "SnackMeal")
                        .WithMany()
                        .HasForeignKey("SnackMealId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Fridge_app.Models.User", "User")
                        .WithMany("WeeklyMealPlanDays")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fridge_app.Models.User", b =>
                {
                    ...
                    b.Navigation("WeeklyMealPlanDays");
                });
